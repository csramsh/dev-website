...
import { siteUrl } from '../utils/url.ts'
...
The CSRA Mesh uses the standard **LongFast** default settings. See the <Link href={siteUrl('/faqs')}>FAQs & Guides</Link> page for setup instructions.
...
- See our <Link href={siteUrl('/events')}>Mesh Events</Link> page for the weekly Friday net schedule
