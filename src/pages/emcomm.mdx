...
The CSRA Mesh uses the standard **LongFast** default settings. See the <Link href={url('/faqs')}>FAQs & Guides</Link> page for setup instructions.
...
- See our <Link href={url('/events')}>Mesh Events</Link> page for the weekly Friday net schedule
